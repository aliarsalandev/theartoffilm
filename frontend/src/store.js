...
import {
  ...
  productFormatListReducer,
  productConditionListReducer,
  productRolledFoldedListReducer,
...
const reducer = combineReducers({
  ...
  productConditionList: productConditionListReducer,
  productRolledFoldedList: productRolledFoldedListReducer,
