          ...
          <div className={"flex column between mtb-2"}>
            <div className={`${isMobile ? "" : "plr-2"}`}>
              ...
              <p>
                ...
                my own home cinema! So today, my original film poster collection
                stretches to over 600 titles from around the world – I love the
                UK quad format, but I also have many US 1 sheets, French grandes
                and petites, Italian photobustas and locandinas, Australian
                Daybills and Japanese B2 format posters, ranging in date from
                the 1930s to the modern-day.
              </p>
            </div>
          </div>
